...
#> [Cassette: get] Handling request: GET http://127.0.0.1:37521/get
...
uses. Here’s the cassette we created above:
    ...
    #> - request:
    #>     method: GET
    #>     uri: http://127.0.0.1:37521/get
    #>   response:
    #>     status: 200
    #>     headers:
    #>       Connection: close
    #>       Date: Thu, 17 Sep 2026 10:38:55 GMT
    ...
    #>           "origin": "127.0.0.1",
    #>           "path": "/get",
    #>           "url": "http://127.0.0.1:37521/get"
    #>         }
    #>   recorded_at: 2026-09-17 10:38:55
...
#> [Cassette: body] Handling request: POST http://127.0.0.1:37521/post
...
#> [Cassette: body] Inserting 'body.yml' (with 1 interactions)
#> [Cassette: body]   Mode: replaying
#> [Cassette: body] Handling request: POST http://127.0.0.1:37521/post {"x":1,"y":{"a":1,"b":2}}
