...
#> [Cassette: debugging-1] Handling request: GET http://127.0.0.1:42021/get
...
#> [Cassette: debugging-1] Inserting 'debugging-1.yml' (with 1 interactions)
#> [Cassette: debugging-1]   Mode: replaying
#> [Cassette: debugging-1] Handling request: POST http://127.0.0.1:42021/get
#> [Cassette: debugging-1]   Looking for existing requests using method/uri
...
#> [Cassette: debugging-1] Inserting 'debugging-1.yml' (with 1 interactions)
#> [Cassette: debugging-1]   Mode: replaying
#> [Cassette: debugging-1] Handling request: GET http://127.0.0.1:42021/set
#> [Cassette: debugging-1]   Looking for existing requests using method/uri
#> [Cassette: debugging-1]     Request 1: NO MATCH
...
#> [Cassette: debugging-2] Handling request: GET http://127.0.0.1:42021/get?x=1
#> [Cassette: debugging-2]   Recording response: 200 with 295 bytes of application/json data
#> [Cassette: debugging-2] Handling request: GET http://127.0.0.1:42021/get?x=2
#> [Cassette: debugging-2]   Recording response: 200 with 295 bytes of application/json data
#> [Cassette: debugging-2] Handling request: GET http://127.0.0.1:42021/get?x=3
#> [Cassette: debugging-2]   Recording response: 200 with 295 bytes of application/json data
...
#> [Cassette: debugging-2] Handling request: GET http://127.0.0.1:42021/get?x=4
...
#> [Cassette: nondeterministic] Handling request: GET http://127.0.0.1:42021/get?nonce=eexombwkke
...
#> [Cassette: nondeterministic] Inserting 'nondeterministic.yml' (with 1 interactions)
#> [Cassette: nondeterministic]   Mode: replaying
#> [Cassette: nondeterministic] Handling request: GET http://127.0.0.1:42021/get?nonce=ulbfdpbcyv
#> [Cassette: nondeterministic]   Looking for existing requests using method/uri
